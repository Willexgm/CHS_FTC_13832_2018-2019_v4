...
public class FullSilverPipe {
    ...
    public FullSilverPipe(int width, int height, VuforiaLocalizer passedVuforia) {
    ...
    public void process(Frame frame) {
        ...
        double[] rgbThresholdRed = {140.64747636481155, 255.0};
        double[] rgbThresholdGreen = {140.64748456581032, 255.0};
        double[] rgbThresholdBlue = {140.6474725376788, 255.0};
